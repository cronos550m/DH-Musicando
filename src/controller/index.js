...
module.exports = {listUser, insertUser, updateUser, deleteUser, getRegAlbum, deleteAlbum, getRegistrar, getEditAlbum, getIndex, getAlbumes, getGeneros, getArtistas, editAlbum, putGenero, putArtista, postArtista, regAlbum };
